...
public class ThornsEnchantmentMixin {
    ...
    private void modifyThornsCheck$discardEffect(LivingEntity pUser, Entity pAttacker, int pLevel, CallbackInfo ci, RandomSource randomsource, Map.Entry<EquipmentSlot, ItemStack> entry) {
